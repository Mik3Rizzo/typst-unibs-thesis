// adapted from https://github.com/TGM-HIT/typst-diploma-thesis/blob/ef724b1aa53b33a0250d7a2a84cce176fc547736/docs/template.typ
...
#let project(
  ...
  codly(
    languages: (
      typst: (name: "typ", icon: none, color: rgb("#239DAE")),
    ),
  )
